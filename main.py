...
def main():
    ...
    new_event = my_calendar.create_event(summary='a test event', location='online',
                                         description='this will be a fun thing we do',
                                         stopdatetime=stop, startdatetime=start,
                                         tz=tz)
